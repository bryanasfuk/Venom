...
async def koc(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`HALO GANTENG`")
        await e.edit("`GABUT BET GILA`")
        await e.edit("`MENDING VCS AJA YUUU`")
        await e.edit("`CEK PC MANIEEZZZZZ`")
        await e.edit("`AKU TUNGGU VCS NYA YAH`")
        await e.edit("`HAHAHAHAHAHA MEMEQ BAU`")
        await e.edit("`BACOT KONTOL`")
        await e.edit("`KONTOL KONTOL PISANG`")
        await e.edit("`SULAP BWAH`")
        await e.edit("🙂🙂🙂🙂")
        await e.edit("😈😈😈😈")
        await e.edit("🙂🙂🙂🙂")
        await e.edit("😈😈😈😈")
        await e.edit("`KONTOLLLLLL`")
        await e.edit("💀💀💀💀💀")
        await e.edit("👌                       👈")
        await e.edit("👌                      👈")
        await e.edit("👌                     👈")
        ...
        await e.edit("K                  O N")
        await e.edit("K                O N")
        await e.edit("K              O N T")
        await e.edit("K             O N T")
        await e.edit("K            O N T")
        await e.edit("K          O N T O")
        await e.edit("K         O N T O")
        await e.edit("K       O N T O L")
        await e.edit("K     O N T O L L")
        await e.edit("K    O N T O L L")
        await e.edit("K   O N T O L L")
        await e.edit("K  O N T O L L")
        await e.edit("K O N T O L L")
